...
<main>
    <div class="row g-3 mt-3" style="max-width: 850px;margin: auto">
        <h1 class="mt-5" style="max-width: 850px;margin: auto">Paniel de Cadastro de Usuários</h1>
        <section>
...
<form class="row g-3" style="max-width: 850px;margin: auto" method="POST" action="{{ route('admin.inserteLeitorDo')}}">
    @csrf
    <div class="mb-6"></div>
    @if($errors->any())
